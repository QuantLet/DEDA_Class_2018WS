...
load("epk3VolaIntervalsVDAX/locLinBW.RData")
...
for (trading_year in 2012) {
  ...
  # path to Data 
  pathToData = paste("epk3VolaIntervalsVDAX/C_", as.character(year), ".csv", sep = "")
  ...
  bothIndexesDax      = read.csv("epk3VolaIntervalsVDAX/timeSeriesDaxVdax.csv")
  ...
  save(vola_levels, 
       ...
       mediumVolaIntUp, 
       highVolaIntUp, 
       file = paste0("epk3VolaIntervalsVDAX/listRndPDpkMain", year, ".RData"))
  ...
  plotPK = function(yearItem){
    ...
    load(paste0("epk3VolaIntervalsVDAX/listRndPDpkMain", as.character(yearItem), ".RData"))
    ...
    plotName = paste("epk3VolaIntervalsVDAX/",
                     "epk3VolaIntervalsVDAX",
                     "_",
                     remarkPlot,
                     "_",
                     "PK",
