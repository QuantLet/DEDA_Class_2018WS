...
load("epk3VolaIntervalsVDAX1m/locLinBWvdax1m.RData")
...
for (trading_year in 2012) {
  ...
  # path to Data 
  pathToData = paste("epk3VolaIntervalsVDAX1m/C_", as.character(year), "vdax1m", 
                     ".csv", sep = "")
  ...
  bothIndexesDax      = read.csv("epk3VolaIntervalsVDAX1m/timeSeriesDaxVdax1m.csv")
  ...
  save(vola_levels, 
       ...
       mediumVolaIntUp, 
       highVolaIntUp, 
       file = paste0("epk3VolaIntervalsVDAX1m/listRndPDpkVDAX1m", year, ".RData"))
  ...
  plotPK = function(yearItem){
    ...
    load(paste0("epk3VolaIntervalsVDAX1m/listRndPDpkVDAX1m", as.character(yearItem), ".RData"))
    ...
    plotName = paste("epk3VolaIntervalsVDAX1m/",
                     "epk3VolaIntervalsVDAX1m",
                     "_",
                     "PK",
                     as.character(year),
                     ".png", sep = "")
