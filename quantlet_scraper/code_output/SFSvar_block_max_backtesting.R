...
# ------------------------------------------------------------------------------ Description: SFSvar_block_max_backtesting
# provides backtesting results for Value-at-Risk with Block Maxima Model.  Corresponds to exercise 16.9 in SFS.
# ------------------------------------------------------------------------------ Usage: -
# ------------------------------------------------------------------------------ Inputs: x,y,z - vector of returns v -
# values of Value at Risk h - size of the window
# ------------------------------------------------------------------------------ Output: p - Exceedances ratio Plot for the
# Value-at-Risk estimation at 0.05 level a portfolio of Bayer, BMW and Siemens stock for the time period from 1992-01-01 to
# 2006-09-01.  ------------------------------------------------------------------------------ Example: -
# ------------------------------------------------------------------------------ Reference Franke, J., Härdle, W. and
# Hafner, Ch.(2004) Statistics of Financial Markets: An Introduction
# ------------------------------------------------------------------------------ Author: Lasse Groth 20091030
# ------------------------------------------------------------------------------
