...
pk1mVDAX1m = function(bothIndexesDax, numberPK){
  ...
  for (trading_year in 2012) {
    ...
    plotPK = function(yearItem){
      ...
      # load precomputed objects
      load(paste0("termStructurePK/listRndPDpkVDAX1m", as.character(yearItem), ".RData"))
...
pk2mVDAX2m = function(bothIndexesDax, numberPK){
  ...
  for (trading_year in 2012) {
    ...
    plotPK = function(yearItem){
      ...
      # load precomputed objects
      load(paste0("termStructurePK/listRndPDpkVDAX2m", as.character(yearItem), ".RData"))
...
pk3mVDAX3m = function(bothIndexesDax, numberPK){
  ...
  for (trading_year in 2012) {
    ...
    plotPK = function(yearItem){
      ...
      # load precomputed objects
      load(paste0("termStructurePK/listRndPDpkVDAX3m", as.character(yearItem), ".RData"))
...
pk1mVDAX1m(bothIndexesDax, 10)
pk2mVDAX2m(bothIndexesDax, 10)
pk3mVDAX3m(bothIndexesDax, 10)
