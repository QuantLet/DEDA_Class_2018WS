...
## [<img src="https://github.com/QuantLet/Styleguide-and-FAQ/blob/master/pictures/qloqo.png" alt="Visit QuantNet">](http://quantlet.de/) **DEDA_Class_2018WS_Berlin_Property_Analysis_Gmap_Plotter** [<img src="https://github.com/QuantLet/Styleguide-and-FAQ/blob/master/pictures/QN2.png" width="60" alt="Visit QuantNet 2.0">](http://quantlet.de/)
...
Description: 'Example Quantlet for charting spatial data collected for this
              project. This file plots all transit data for the city of Berlin, DE.'
...
See also: '1) pre_generated/html_renderings/*.html
           2) pre_generated/output_maps/*.png
           3) runtime_generated/html_renderings/*.html'

```

![Picture1](transport_all.png)

![Picture2](transport_bus.png)

![Picture3](transport_sbahn.png)

![Picture4](transport_tram.png)

![Picture5](transport_ubahn.png)
