...
# case 3: 0
<h<1 -="">
 take slices with range in percent. of the y-range    

}else if((0
 <hold) #="" &&(hold<="1))" (slend[ns]="" *="" -="" and="" by="slwidth)" compute="" data[1,1])="" h="" if="" intervals="" length="ns," limit="" ns="floor(1/h)" number="" of="" slend="seq(data[1,1]+slwidth," slice="" slices="" slwidth="(data[n,1]" upper="" vector="" width="" {="">
  data[n-1,1]){      # does only the last value            
